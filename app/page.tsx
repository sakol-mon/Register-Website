...
const speakers = [
  {
    image: speakerImage1,
    name: "ผศ.ดร.เธษฎา อานิล",
    position: "ผู้ช่วยอธิการบดีฝ่ายการศึกษา และอาจารย์ประจำภาควิชากายวิภาคศาสตร์ คณะแพทยศาสตร์ มหาวิทยาลัยมหิดล",
    topic: "NotebookLM",
  ...
  {
    image: speakerImage3,
    name: "ว่าที่ ร.ต.ธีรพงษ์ กันกลับ",
  ...
  },
  {
    ...
    topic: "PRISM & SCOPUS AI และ Antigravity 2.0",
...
const faq = [
  ...
  },
  {
    ...
    answer: "ควรเตรียมคอมพิวเตอร์พกพา อีเมลมหาวิทยาลัย และความพร้อมในการทดลองใช้เครื่องมือ AI กับกรณีศึกษาจริงทางวิชาการ",
  },
  {
